...
namespace TestCases.TestToolSet.Net {

    /// <summary>
    /// Common functionality to access error information that may not propegate from
    /// a class on test. The Net Standard objects used
    /// </summary>

    public class HelperLogReaderNet {
        ...
        public HelperLogReaderNet(MsgLevel level, int numberOfMsgBeforeDumpToLog) {
