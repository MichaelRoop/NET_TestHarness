...
namespace TestCases.SpStateMachineTests {
    ...
    public class smDerivedManagedFail : SpMachine<IDisposable,MyEventType> {
        public smDerivedManagedFail(IDisposable wo, ISpState<MyEventType> state)
            : base(wo, state) {
        }
    ...
    public class smDerivedNativeFail : SpMachine<IDisposable, MyEventType> {
        public smDerivedNativeFail(IDisposable wo, ISpState<MyEventType> state)
            : base(wo, state) {
        }
    ...
    public class SpStateMachineTests {
        ...
        public void _0_Dispose_Multi() {
            ISpState<MyEventType> st = MockRepository.GenerateMock<ISpState<MyEventType>>();
        ...
        public void _50170_Ctor_WrappedObject() {
            ...
            TestHelpersNet.CatchExpected(50170, "SpMachine`2", ".ctor", "Null wrappedObject Argument", () => {
                ISpStateMachine sm = new SpMachine<IDisposable,MyEventType>(null, st);
                sm.Dispose();
            });
        }
        ...
        public void _50171_Ctor_NullState() {
            ...
            TestHelpersNet.CatchExpected(50171, "SpMachine`2", ".ctor", "Null state Argument", () => {
                ISpStateMachine sm = new SpMachine<IDisposable,MyEventType>(wo, null);
                sm.Dispose();
            });
        }
